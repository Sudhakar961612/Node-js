      ...
      <fieldset>
        ...
        <div className='form-group'>
          ...
          <div className='col-md-4'>
            <input id='title' name='title' type='text' placeholder='title' className='form-control input-md' onChange={handleChange} />
          </div>
        </div>
        <div className='form-group'>
          ...
          <div className='col-md-4'>
            <input id='thumbnail' name='thumbnail' type='text' placeholder='thumbnail' className='form-control input-md' onChange={handleChange} />
          </div>
        </div>
        <div className='form-group'>
          ...
          <div className='col-md-4'>
            <input id='price' name='price' type='number' placeholder='price' className='form-control input-md' onChange={handleChange} />
          </div>
        </div>
        {/* Select Basic */}
        <div className='form-group'>
        ...
        <div className='form-group'>
          ...
          <div className='col-md-4'>
            <input id='discountPercentage' name='discountPercentage' type='number' placeholder='discountPercentage' className='form-control input-md' onChange={handleChange} />
